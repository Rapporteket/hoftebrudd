...
params:
  ...
  bins: 5
title: Samlerapport
subtitle: en eksempelrapport fra hoftebrudd
author: Rapporteket
userFullName: Tore Tester
registryName: SKDE
reglogo: '`r system.file("logo.png", package = "hoftebrudd")`'
regtext: '`r readLines(system.file("shortDescription.txt", package = "hoftebrudd"))`'
...
f <- hoftebrudd::makeSimpleHist(df = mtcars, var = params$var, bins = params$bins, makeTable = FALSE)
```
